  ...
  return (
    <div className='flex flex-col gap-[20px]' id='explore-menu'>
      <h1 className='text-[#262626] font-bold text-5xl'>Explore our menu</h1>
        <p className='md:max-w-[45%] sm:max-w-[100%]  text-[#808080]'>Choose from a diverse menu featuring a delectable array of dishes.Our mission is to satisfy your craving and elevate your dining ,One delicious meal at a time.</p>
